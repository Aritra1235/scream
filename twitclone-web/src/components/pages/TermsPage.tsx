        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            ...
            <p className="text-xl md:text-2xl font-bold mb-6 max-w-2xl mx-auto bg-white border-4 border-black p-6 shadow-[8px_8px_0px_0px_rgba(0,0,0,1)]">
              Legal agreement governing your use of SCREAM. Please read
              carefully.
            </p>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          >
            <div className="space-y-4">
              <p className="text-lg leading-relaxed">
                By accessing, browsing, or using SCREAM ("the Service",
                "Platform", "we", "us", or "our"), you acknowledge that you have
                read, understood, and agree to be bound by these Terms of
                Service ("Terms") and our Privacy Policy, incorporated herein by
                reference.
              </p>
              <p className="text-lg leading-relaxed">
                These Terms constitute a legally binding agreement between you
                ("User", "you", or "your") and SCREAM. If you do not agree to
                these Terms, you must immediately cease using the Service.
              </p>
              <p className="text-lg leading-relaxed">
                By creating an account or using the Service, you represent and
                warrant that you have the legal capacity to enter into this
                agreement and are not prohibited from using the Service under
                applicable law.
              </p>
            </div>
          </InfoCard>
          ...
          >
            <div className="space-y-4">
              <p className="text-lg leading-relaxed">
                ...
                of age to use SCREAM. If you are between 13 and 18 years of age
                (or the age of legal majority in your jurisdiction), you may
                only use the Service with the consent and supervision of a
              ...
              <p className="text-lg leading-relaxed">
                ...
                Fraudulent, false, or misleading information may result in
                immediate termination of your account.
              </p>
              <p className="text-lg leading-relaxed">
                <strong>Prohibited Users:</strong> Use of the Service is
                prohibited for individuals or entities in jurisdictions where
                such use would violate applicable laws, or for individuals
                previously banned or suspended from the Service.
              </p>
            </div>
          </InfoCard>
            ...
            <div className="space-y-6">
              <div>
                ...
                <p className="text-lg leading-relaxed">
                  ...
                  of your account credentials, including your password. You
                  agree to immediately notify SCREAM of any unauthorized access
                  or security breach. You are liable for all activities
                  conducted through your account, whether authorized by you or
                  not, until you notify us of a breach.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-lg leading-relaxed">
                  ...
                  including for purposes of evading bans or restrictions, is
                  strictly prohibited and will result in immediate suspension or
              ...
              <div>
                ...
                <p className="text-lg leading-relaxed">
                  Your account is personal to you. You may not sell, transfer,
                  or assign your account or any account rights to any third
          ...
          >
            <div className="space-y-6">
              <div>
                ...
                <p className="text-lg leading-relaxed">
                  You retain all ownership rights to content you submit, post,
                  or display on or through the Service ("User Content").
                  However, by posting User Content, you grant SCREAM a
                  worldwide, non-exclusive, royalty-free, transferable,
                  sublicensable license to use, copy, reproduce, process, adapt,
                  modify, publish, transmit, display, distribute, and create
                  derivative works of such User Content in connection with
              ...
              <div>
                ...
                <p className="text-lg leading-relaxed">
                  ...
                  rights to post your User Content, (ii) your User Content does
                  not violate any third-party rights, including intellectual
                  property, privacy, or publicity rights, and (iii) posting your
                  User Content does not violate any applicable laws or
                  regulations.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-lg leading-relaxed">
                  ...
                  review, or remove User Content at our sole discretion, for any
                  reason, including content that violates these Terms or is
                  otherwise objectionable. We do not endorse or guarantee the
                  accuracy, integrity, or quality of User Content.
                </p>
              </div>
            </div>
          </InfoCard>
            ...
            <div className="space-y-4">
              ...
              <ul className="list-disc list-inside space-y-2 text-lg leading-relaxed ml-4">
                <li>
                  ...
                  privacy, hateful, or racially or ethnically offensive
                </li>
                <li>
                ...
                <li>
                  Posting content that infringes any patent, trademark, trade
          ...
          >
            <div className="space-y-4">
              <p className="text-lg leading-relaxed">
                ...
                property of SCREAM and its licensors. The Service is protected
                by copyright, trademark, and other laws of both domestic and
              ...
              <p className="text-lg leading-relaxed">
                ...
                written consent. All other trademarks, service marks, and logos
                used on the Service are the property of their respective owners.
              </p>
              <p className="text-lg leading-relaxed">
                <strong>DMCA Compliance:</strong> We respect intellectual
                property rights. If you believe that any content on the Service
                infringes your copyright, please contact us with a detailed
                notice including: (i) identification of the copyrighted work,
                (ii) identification of the infringing material, (iii) your
                contact information, (iv) a statement of good faith belief, and
          ...
          >
            <div className="space-y-4">
              <p className="text-lg leading-relaxed">
                ...
                or resources that are not owned or controlled by SCREAM. We have
                no control over, and assume no responsibility for, the content,
                privacy policies, or practices of any third-party websites or
                services.
              </p>
              <p className="text-lg leading-relaxed">
                You acknowledge and agree that SCREAM shall not be responsible
                ...
                available through such websites or services.
              </p>
              <p className="text-lg leading-relaxed">
          ...
          >
            <div className="space-y-4">
              ...
              <p className="text-lg leading-relaxed">
                SCREAM expressly disclaims all warranties, whether express,
                implied, or statutory, including but not limited to implied
                warranties of merchantability, fitness for a particular purpose,
                title, and non-infringement. We do not warrant that:
              </p>
              <ul className="list-disc list-inside space-y-2 text-lg leading-relaxed ml-4">
          ...
          >
            <div className="space-y-4">
              ...
              <p className="text-lg leading-relaxed">
                ...
                related to the Service shall not exceed the greater of (i) the
                amount you have paid SCREAM in the 12 months prior to the claim,
                or (ii) $100 USD.
              </p>
            </div>
          </InfoCard>
          ...
          >
            <div className="space-y-4">
              ...
              <ul className="list-disc list-inside space-y-2 text-lg leading-relaxed ml-4">
                ...
                <li>
                  Any claim that your User Content caused damage to a third
                  party
                </li>
              </ul>
              <p className="text-lg leading-relaxed">
            ...
            <div className="space-y-6">
              <div>
                ...
                <p className="text-lg leading-relaxed">
                  ...
                  notice, for any reason or no reason, including without
                  limitation if we believe you have violated these Terms,
                  engaged in fraudulent or illegal activity, or for extended
              ...
              <div>
                ...
                <p className="text-lg leading-relaxed">
                  ...
                  account deletion process in your account settings. Upon
              ...
              <div>
                ...
                <p className="text-lg leading-relaxed">
                  Upon termination, we may delete your User Content. Some
                  provisions of these Terms shall survive termination, including
                  but not limited to: ownership provisions, warranty
            ...
            <div className="space-y-6">
              <div>
                ...
                <p className="text-lg leading-relaxed">
                  ...
                  with the laws of the jurisdiction in which SCREAM operates,
              ...
              <div>
                ...
                <p className="text-lg leading-relaxed">
                  If you have any dispute with us, you agree to first contact us
                  and attempt to resolve the dispute informally. We will attempt
          ...
          >
            <div className="space-y-4">
              <p className="text-lg leading-relaxed">
                ...
                effect through a notice on the Service or by sending you an
              ...
              <p className="text-lg leading-relaxed">
                We may also update or modify the Service from time to time,
                including by adding or removing features or functionality. We
                are not obligated to provide any updates or continue to provide
                particular features.
              </p>
            </div>
          </InfoCard>
            ...
            <div className="space-y-6">
              <div>
                ...
                <p className="text-lg leading-relaxed">
                  ...
                  entire agreement between you and SCREAM regarding the Service
              ...
              <div>
                ...
                <p className="text-lg leading-relaxed">
                  ...
                  will not be considered a waiver of those rights. Any waiver
          ...
          >
            <div className="space-y-4">
              <p className="text-lg leading-relaxed">
                ...
                Terms or the Service, please contact us:
              </p>
