...
export default function Onboarding() {
  ...
  const handleFileChange =
    (field: "profilePicture" | "bannerPicture") =>
    async (e: React.ChangeEvent<HTMLInputElement>) => {
      ...
      try {
        ...
        setError(
          `Failed to upload ${isAvatar ? "profile picture" : "banner"}. Please try again.`,
        );
      ...
      <div className="max-w-md w-full">
        ...
        <div className="mb-8">
          <div className="flex justify-between items-center mb-2 max-w-sm mx-auto">
            {(
              ["username", "displayName", "bio", "images"] as OnboardingStep[]
            ).map((step, index) => (
        ...
        <Card className="shadow-2xl shadow-primary/5 border-0 bg-card">
          <CardHeader className="text-center pb-6">
            ...
            <CardDescription className="text-muted-foreground">
              ...
              {currentStep === "images" &&
                "Upload a profile and banner picture (optional)"}
            </CardDescription>
          </CardHeader>
